...
static void get_source_info_callback( pa_context *c, const pa_source_info *i, int is_last, void *userdata ) {
	...
	if ( i->monitor_of_sink != PA_INVALID_INDEX ) {
		...
		device = pa_xstrdup( i->name );//"alsa_input.usb-0d8c_USB_Sound_Device-00.analog-stereo"
		//"alsa_input.usb-OmniVision_Technologies__Inc._USB_Camera-B4.09.24.1-01.multichannel-input"
